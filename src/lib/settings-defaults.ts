...
// 기본 문구 — 변수 없이 자연스러운 한국어로 작성된 fallback 문구
// 커스텀 template 이 null 이거나 빈 경우에만 사용됨
export const DEFAULT_MSG_TEMPLATE: Record<string, (p: Record<string, string>) => string> = {
  '예약확정알림':
    () => `[일잇다] 안녕하세요! 서비스 예약이 확정되었습니다.\n방문 일정은 별도 안내드리겠습니다.\n궁금하신 점은 언제든 문의 주세요. 감사합니다.`,

  '예약1일전알림':
    () => `[일잇다] 안녕하세요! 내일 서비스 방문 예정입니다.\n현장 준비 부탁드립니다.\n변경사항 있으시면 미리 연락 주세요. 감사합니다.`,

  '예약당일알림':
    () => `[일잇다] 안녕하세요! 오늘 서비스 방문 예정입니다.\n현장 준비 부탁드립니다. 감사합니다.`,

  '서비스완료알림':
    () => `[일잇다] 안녕하세요! 서비스가 완료되었습니다.\n이용해 주셔서 감사합니다.\n불편하신 점은 언제든 연락 주세요.`,

  '결제알림':
    () => `[일잇다] 안녕하세요! 서비스 대금 결제를 안내드립니다.\n계좌 정보는 담당자에게 문의 주세요.\n입금 확인 후 영수증 발송 예정입니다. 감사합니다.`,

  '결제완료알림':
    () => `[일잇다] 안녕하세요! 입금이 확인되었습니다.\n이용해 주셔서 감사합니다.`,

  '결제완료알림(잔금)':
    () => `[일잇다] 안녕하세요! 잔금 입금이 확인되었습니다.\n이용해 주셔서 감사합니다.`,

  '계산서발행완료알림':
    () => `[일잇다] 안녕하세요! 세금계산서가 발행되었습니다.\n이메일로 전송된 계산서를 확인해 주세요. 감사합니다.`,

  '예약금 입금완료 알림':
    () => `[일잇다] 안녕하세요! 예약금 입금이 확인되었습니다.\n예약이 정상 접수되었습니다.\n서비스 일정은 별도 안내드리겠습니다.`,

  '예약금환급완료알림':
    () => `[일잇다] 안녕하세요! 예약금 환급이 완료되었습니다.\n영업일 기준 3~5일 내 입금됩니다. 감사합니다.`,

  '예약취소알림':
    () => `[일잇다] 안녕하세요! 예약이 취소되었습니다.\n불편을 드려 죄송합니다.\n문의사항은 언제든 연락 주세요.`,

  'A/S방문알림':
    () => `[일잇다] 안녕하세요! A/S 방문 일정을 안내드립니다.\n방문 전 연락드리겠습니다. 감사합니다.`,

  '방문견적알림':
    () => `[일잇다] 안녕하세요! 방문 견적 일정을 안내드립니다.\n현장 확인 후 정확한 견적을 제공해 드리겠습니다.`,

  '폴더링크알림':
    () => `[일잇다] 안녕하세요! 서비스 작업 사진을 공유드립니다. 감사합니다.`,
}

// 각 알림 타입별 초기 커스텀 문구 (변수 포함, 알찬 내용)
// DEFAULT_NOTIFICATION_CONFIG 생성 시 template 기본값으로 사용됨
const INITIAL_TEMPLATES: Partial<Record<string, string>> = {
  '예약확정알림':
`[일잇다] {business_name} 담당자님, 안녕하세요!
서비스 예약이 확정되었습니다.
...
궁금하신 점은 언제든 문의 주세요.`,
  ...
  '예약1일전알림':
`[일잇다] {business_name} 담당자님, 안녕하세요!
내일({construction_date}) 서비스 방문 예정입니다.

방문 예정 시간: {construction_time}
주소: {address}

변경 또는 문의사항은 미리 연락 부탁드립니다.
감사합니다.`,

  '예약당일알림':
`[일잇다] {business_name} 담당자님, 안녕하세요!
오늘({construction_date}) 서비스 방문 예정입니다.
...
서비스 이용에 감사드립니다.
또 필요하신 것이 있으면 언제든 연락 주세요.`,

  '결제완료알림(잔금)':
`[일잇다] {business_name} 담당자님, 안녕하세요!
잔금 입금이 확인되었습니다. 감사합니다!

총 결제 금액: {supply_total}
서비스 이용에 감사드립니다.`,
...
불편을 드려 죄송합니다.
취소 관련 문의사항은 언제든 연락 주세요.`,

  'A/S방문알림':
`[일잇다] {business_name} 담당자님, 안녕하세요!
A/S 방문 일정을 안내드립니다.

방문 예정일: {construction_date} {construction_time}
주소: {address}
...
export const DEFAULT_NOTIFICATION_CONFIG: NotificationConfig = {
  rules: NOTIFY_TYPES.map((type) => ({
    ...
    trigger: undefined,
    template: INITIAL_TEMPLATES[type] ?? null,
